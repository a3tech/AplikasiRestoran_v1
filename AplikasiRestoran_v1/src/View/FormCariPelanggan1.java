...
public class FormCariPelanggan1 extends javax.swing.JDialog {
    ...
    public FormCariPelanggan1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    trxx.idpelanggan = tblPelanggan.getValueAt(baris, 0).toString();
    trxx.nama = tblPelanggan.getValueAt(baris, 1).toString();
    this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormCariPelanggan1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormCariPelanggan1 dialog = new FormCariPelanggan1(new javax.swing.JFrame(), true);
