...
public class FormCariMenu1 extends javax.swing.JDialog {
    ...
    private Entitas m;
    private int baris;
    public FormTransaksiDelivery trxx;
    ...
    public FormCariMenu1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    trxx.kdmenu = tblMenu.getValueAt(baris, 0).toString();
    trxx.namamenu = tblMenu.getValueAt(baris, 1).toString();
    trxx.harga=Integer.parseInt(tblMenu.getValueAt(baris, 2).toString());
    this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormCariMenu1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormCariMenu1 dialog = new FormCariMenu1(new javax.swing.JFrame(), true);
